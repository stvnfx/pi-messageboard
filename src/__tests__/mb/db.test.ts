...
describe('mb_loops', () => {
  it('creates and retrieves a loop', () => {
    const loop = mbDb.createMbLoop('Zeus-test1', 'Fix tests', 'All pass', 10, 'anthropic/claude-sonnet-4-5');
  ...
  it('updates loop fields', () => {
    ...
    mbDb.updateMbLoop(loop.id, { iteration: 5, status: 'stuck', last_notice: 'Repeated 3x' });
